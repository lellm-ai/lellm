...
pub use tools::{
    ...
    FallbackStrategy, ParallelSafety, ResolvedModel, RetryPolicy, StopReason,
    ToolCategory, ToolError, ToolErrorKind, ToolExecutor, ToolRegistration, ToolRegistry,
    ToolResult, ToolSearchResult, ToolSource, ToolUseLoop, ToolUseResult,
};
